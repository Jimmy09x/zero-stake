...
INCLUDEPATH += src/leveldb/include src/leveldb/helpers C:\zerostake\db-4.8.30.NC\build_unix
...
isEmpty(BDB_LIB_PATH) {
    windows:BDB_LIB_PATH = C:\zerostake\db-4.8.30.NC\build_unix
}
...
isEmpty(BDB_INCLUDE_PATH) {
    windows:BDB_INCLUDE_PATH = C:\zerostake\db-4.8.30.NC\build_unix
}

isEmpty(OPENSSL_LIB_PATH) {
    windows:OPENSSL_LIB_PATH = C:\zerostake\openssl-1.0.2o
}

isEmpty(OPENSSL_INCLUDE_PATH) {
    windows:OPENSSL_INCLUDE_PATH = C:\zerostake\openssl-1.0.2o\include
}

isEmpty(BOOST_LIB_PATH) {
    windows:BOOST_LIB_PATH = C:\zerostake\boost_1_55_0\boost_1_55_0\stage\lib
}

isEmpty(BOOST_INCLUDE_PATH) {
    windows:BOOST_INCLUDE_PATH = C:\zerostake\boost_1_55_0\boost_1_55_0
}

isEmpty(MINIUPNPC_LIB_PATH) {
    windows:MINIUPNPC_LIB_PATH = C:\zerostake\miniupnpc
}

isEmpty(MINIUPNPC_INCLUDE_PATH) {
    windows:MINIUPNPC_INCLUDE_PATH = C:\zerostake\miniupnpc
}
